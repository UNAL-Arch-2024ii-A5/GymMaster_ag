...
const machinesQueries = {
  ...
  getMachinesByType: async (_, { type }) => {
    try {
      const response = await axios.get(`${process.env.MONITORING_URL}/machine/type/${type}`);
      return response.data
    } catch (error) {
      console.error('Error fetching Machines:', error);
  ...
  getMachine: async (_, { id }) => {
    try {
      const response = await axios.get(`${process.env.MONITORING_URL}/machine/${id}`);
      return response.data
    } catch (error) {
      console.error('Error fetching Machines:', error);
      throw new Error('Machines not found');
...
const monitoringQueries = {
  allMonitoringEvents: async () => {
    try {
      const response = await axios.get(`${process.env.MONITORING_URL}/monitoring`);
      return response.data
    } catch (error) {
  ...
  getMonitoringEventByID: async (_, { id }) => {
    try {
      const response = await axios.get(`${process.env.MONITORING_URL}/monitoring/${id}`);
      return response.data
    } catch (error) {
  ...
  getUsage: async (_, { type }) => {
    try {
      const response = await axios.get(`${process.env.MONITORING_URL}/monitoring/usage?type=${type}`);
      return response.data
    } catch (error) {
      console.error('Error fetching monitor event:', error);
      throw new Error('monitor event not found');
