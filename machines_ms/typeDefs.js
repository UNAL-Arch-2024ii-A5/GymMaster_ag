const typeDefs = `
    ...
    type Mutation {
        createMachineMS(name: String!, description: String, state: String, lastService: String, serviceInterval: Int): Machine
        updateMachineMS(id: ID!, name: String, description: String, state: String, lastService: String, serviceInterval: Int): Machine
